...
export async function POST(request: NextRequest) {
  try {
    ...
    // Use vercel.app logo URL for maximum Gmail compatibility
    const logoUrl = "https://ns-financial-services.vercel.app/logo.png";
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; border: 1px solid #e0e0e0; border-radius: 8px; padding: 24px; background: #fafbfc;">
          <div style="text-align:center;">
            <img src='https://ns-financial-services.vercel.app/logo.png' alt="NS Financial Logo" style="height: 100px;">
          </div>
